...
<title>${not empty pageTitle ? pageTitle : 'SHOP'}&nbsp;-&nbsp;SHOP</title>
...
<%-- Cho phep tung trang con nhung noi dung rieng vao <head> (vd: CSS/JS rieng) --%>
...
<body>
	...
	<div class="main-wrapper">
		...
		<footer class="footer-custom">
			<div class="footer-left">
				<span class="footer-logo"> <i class="bi bi-bag-heart-fill"></i>
					SHOP
				</span> <span class="footer-separator">|</span> <span class="footer-copy">&copy;
					2026 - Lap trinh Web</span>
			</div>
		</footer>
	...
	<script src="${ctx}/assets/libs/apexcharts/apexcharts.min.js"></script>
	<script src="${ctx}/assets/libs/flatpickr/flatpickr.min.js"></script>
