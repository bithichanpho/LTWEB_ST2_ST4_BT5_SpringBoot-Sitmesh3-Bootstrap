...
<div class="card border-light shadow-sm p-4">
  ...
  <form:form modelAttribute="userForm" action="${ctx}/admin/users/saveOrUpdate" method="post">
    ...
    <div class="row g-3">
      ...
      <div class="col-md-6">
        <label class="form-label-custom">Mat khau moi</label>
        <form:password path="password" cssClass="form-control-custom" placeholder="De trong neu khong doi mat khau" autocomplete="new-password" />
